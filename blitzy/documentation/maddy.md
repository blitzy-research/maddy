...
```
v=DKIM1; k=rsa; p=
```
...
```
v=DKIM1; k=ed25519; p=EuzirQQd4q4JZXS8WZ5QoQekwbnS3moYfhmn6SF+jOc=
```
...
**Five real outputs** (generated by running the equivalent Go code: `rand.Read(rawID)` + `hex.EncodeToString(rawID)` from the investigation binary):
...
This produces a header like: `Message-ID: <b149ccee-9df1-4237-a33d-9eb434c7a467@example.com>`

**Five real outputs** (generated by running the equivalent Go code: `uuid.NewRandom()` + `id.String()` from the investigation binary using `github.com/google/uuid` v1.1.1):

```
b149ccee-9df1-4237-a33d-9eb434c7a467
ee6ec9de-6bac-4bba-aa9f-6406d8fccd66
ab0b2498-7760-4722-9f59-314cea422a87
7ab6b2b9-128d-49d3-ab7e-908296b80e56
e762260c-b981-4acf-aa79-2b2b1ece3b95
```
